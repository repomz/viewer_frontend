...
const requirements = [
  ...
  [html.includes("#viewer-preboot.viewer-entry-ready #viewer-preboot-version"), "persistent launch canvas must only fade its foreground label"],
  [html.includes("#viewer-login") && html.includes("background: transparent !important"), "web login must reveal the persistent launch canvas"],
